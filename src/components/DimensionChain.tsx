  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:gap-4">
        {stages.map((stage, i) => (
          <Reveal key={stage} delayMs={i * 100}>
            <div className="group relative flex flex-col justify-between rounded-xl border border-[var(--rule)] bg-[var(--card)] p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--brand)] hover:shadow-md">
